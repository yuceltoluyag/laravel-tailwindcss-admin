...
task('development', series('clean:dist','dev-styles','dev-scripts','dev-imgs',(done)=>{
    console.log("\n\t" + logSymbols.info,"npm run dev is complete. Files are located at ./dist\n");
    done();
}));

task('optamizedBuild', series('clean:build','dev-styles','build-styles','build-scripts','build-imgs',(done)=>{
